# Content brief: Walks, viewpoints and wild places in Laois

Status: editorial review required
Target route: /guides/laois/outdoor-adventures
...
- [Glenbarrow Waterfall Loop](/place/18/glenbarrow-waterfall-loop): A three-tiered waterfall hidden in the Slieve Bloom Mountains; Free; 7 km loop
- [Ridge of Capard](/place/92/ridge-of-capard): A boardwalk to wide views from the Slieve Blooms; Free; 2 km loop

## Recommended intent

Help someone choose and plan a real outing in Laois. Answer practical questions early; do not pad the page with generic county history.
...
- Internal links to every cited place and the Laois county hub
