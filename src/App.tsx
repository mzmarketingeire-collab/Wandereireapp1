  ...
  useEffect(() => {
    ...
    void Promise.all([mapLibraryPromise, styleRequest]).then(([library, requested]) => {
      ...
      const instance = new library.Map({
        ...
        bounds: [[-11.25, 51.15], [-5.15, 55.65]],
        fitBoundsOptions: { padding: 28, maxZoom: 6.25 },
        maxBounds: [[-12.5, 50.55], [-4.75, 56.35]],
      ...
      instance.once('load', () => {
        instance.addSource('great-britain-mask', { type: 'geojson', data: greatBritainMask })
        instance.addLayer({ id: 'great-britain-muted', type: 'fill', source: 'great-britain-mask', paint: { 'fill-color': '#b8b9b4', 'fill-opacity': 0.96 } })
        instance.addLayer({ id: 'great-britain-edge', type: 'line', source: 'great-britain-mask', paint: { 'line-color': '#959993', 'line-width': 1 } })
        primarySettled = true
